...
<body>
    <div class="mt-1 enquiry-box right_container">
        ...
        <form id="enquiry-form">
                ...
                <table class="table table-bordered mt-4">
                    <thead>
                        <tr>
                            ...
                            <th style="width:275px">Description Of Goods</th>
                    ...
                    <tbody id="item-container">
                                    ...
                                    <td>
                                        <div style="display: flex; align-items: center; gap: 10px;">
                                            ...
                                            <?php if (!empty($item['images'])): ?>
                                                <img src="<?= base_url('uploads/enquiry/' . $item['images']) ?>"
                                                    style="width:50px; height:50px; " />
                                            <?php endif; ?>

                                            <!-- File input -->
                                            <input type="file" name="item_image[<?= $index ?>]" class="form-control"
                        ...
                        <?php else: ?>
                            <tr class="item-row">
                                ...
                                <td>
                                    <input type="file" name="item_image[0]" class="form-control mt-1" accept="image/*">
                                </td>
                                <td class="text-center">
                                    <span class="remove-item-btn" style="cursor:pointer">
                                        <i class="fas fa-trash text-danger"></i>
            ...
            <div>
                <label class="mt-3"><strong>Special Notes</strong><span class="text-danger">*</span></label>
                <textarea name="note" id="note" class="form-control" rows="3"><?= esc($note) ?></textarea>
            </div>
