    ...
    <div class="row">
        ...
        <div class="card my-4">
            ...
            <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center">
                <h4 class="text-white text-capitalize ps-3 mb-0">Add New Role and Permissions</h4>
                </div>
                    <h5 class="mb-0" style="margin-top:10px";><?= isset($role['role_id']) ? 'Edit Role' : 'Add New Role and Permissions' ?></h5>
                </div>
                ...
                <form id="roleForm" action="<?= base_url('admin/manage_roles/store') ?>" class="p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="role_name" id="role_name" class="form-control capitalize cursor-padding"
                            value="<?= isset($role['role_name']) ? esc($role['role_name']) : '' ?>"autocomplete="off" required>
                    </div>
                    <div class="card mb-3">
