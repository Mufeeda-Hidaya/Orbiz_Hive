<footer class="footer py-3 shadow-sm" style="position:fixed; bottom:0; left:20px; right:20px; width:auto; z-index:1; background-color:white; text-align:center; border-top-left-radius:15px; border-top-right-radius:15px;">
